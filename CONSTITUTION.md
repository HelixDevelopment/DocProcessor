# CONSTITUTION — DocProcessor

Project-specific governance for the **DocProcessor** repository. This document carries the Universal Mandatory Constraints inherited from the cross-project root.
