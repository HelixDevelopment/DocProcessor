...
<!-- ============================================================
     RESIDUAL CASCADE BACKFILL (manual splice, additive §11.4.122)
     CONST-058 + CONST-059 sourced from meta-repo root CONSTITUTION.md
     (canonical consumer-extension carrying the CONST-0NN alias form;
     constitution/Constitution.md uses the numbered §11.4.34/§11.4.35
     form and lacks the CONST-058/059 literal). §11.4.140 + §11.4.141
     sourced from constitution/CLAUDE.md (canonical, §11.4.35).
     ============================================================ -->
