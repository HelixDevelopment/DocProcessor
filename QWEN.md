...
Document-processing pipeline for HelixQA. Decomposes specifications, requirements, and reference documentation into structured forms consumable by Challenges and the LLM orchestration layer.
